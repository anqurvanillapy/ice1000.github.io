---
layout: page
permalink: /lagda/Agda.Builtin.Nat.html
inline_latex: true
agda: true
---
<body>
...
<a id="187" class="Keyword">data</a> <a id="Nat"></a><a id="192" href="Agda.Builtin.Nat.html#192" class="Datatype">Nat</a> <a id="196" class="Symbol">:</a> <a id="198" class="PrimitiveType">Set</a> <a id="202" class="Keyword">where</a>
